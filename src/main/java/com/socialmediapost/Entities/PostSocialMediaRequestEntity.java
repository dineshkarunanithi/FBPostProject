...
public class PostSocialMediaRequestEntity {
	/*
	 * @Id
	 * 
	 ...
	 * 
	 * @Override public String toString() { return "PostSocialMediaRequest [userId="
	 * + userId + ", accessToken=" + accessToken + ", tokenType=" + tokenType +
	 * ", appName=" + appName + "]"; }
	 * 
	 * 
	 * 
